                                            ...
                                            <tr>
                                               ...
                                               <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending"
                                                    style="width: 176.484px;">Category Name </th>                                               
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending"
...
<a class="list-icons-item text-primary" title="Edit"  href="{{ route("product_category.edit",$row->id)}}"><i class="icon-pencil7"></i></a>&nbsp
                                                       

                                                            {!! Form::open(['route' => ['product_category.destroy',$row->id], 'method' => 'delete']) !!}
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                @if(isset($id))
                                                {{ Form::model($id, array('route' => array('product_category.update', $id), 'method' => 'PUT')) }}
                                                @else
